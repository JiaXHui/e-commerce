...
public class Sendsms {
	...
	public static String send(String phone_number) {
		...
		NameValuePair[] data = {//�ύ����
			    new NameValuePair("account", "C32890935"), //�鿴�û����ǵ�¼�û�����->��֤�����->��Ʒ����->APIID
			    new NameValuePair("password", "397996363d84281901facdc27a5dc260"),  //�鿴�������¼�û�����->��֤�����->��Ʒ����->APIKEY
