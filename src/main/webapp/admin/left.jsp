...
<body style="background:#f0f9fd;">
    ...
    <dd>
    <div class="title">
    <span><img src="images/leftico01.png" /></span>黑市功能
    </div>
    	<ul class="menuson">
        ...
        <li><cite></cite><a href="<%=basePath %>CategoryServlet?mark=findCategoryListFY" target="rightFrame">商品类别管理</a><i></i></li>
        <li><cite></cite><a href="<%=basePath %>GoodsServlet?mark=findGoodsListFY" target="rightFrame">商品管理</a><i></i></li>
